...
![University of Iowa](images/iowa.jpg){width=600px style="display: block; margin: 20px auto; border-radius: 12px;"}
![Boston University](images/boston.jpg){width=600px style="display: block; margin: 16px auto; border-radius: 10px;"}
